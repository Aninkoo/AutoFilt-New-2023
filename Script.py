class script(object):
    START_TXT = """★😍 ʜᴇʟʟᴏ {}, ʀᴇᴀᴅʏ ғᴏʀ ᴍᴏᴠɪᴇ ᴍᴀɢɪᴄ?

★🍿 ɪɴᴛʀᴏᴅᴜᴄɪɴɢ <a href=https://t.me/{}>{}</a> – ʏᴏᴜʀ ᴍᴏᴠɪᴇ ᴄᴏᴍᴘᴀɴɪᴏɴ!

★🚀 ᴀᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ғᴏʀ ᴀɴ ɪɴsᴛᴀɴᴛ ᴄɪɴᴇᴍᴀᴛɪᴄ ᴇxᴘᴇʀɪᴇɴᴄᴇ!"""
...
<b>Share if you care : @Isaimini_updates or @Isaimini_Filter_bot</b>"""
    ...
    <b>❌ Don't Ask Me To Send Movies In PM 😵‍💫 </b>
...
🛠️ 𝖡𝗎𝗂𝗅𝖽 𝖲𝗍𝖺𝗍𝗎𝗌 : <code>𝗏2.7.3 [ 𝖲𝗍𝖺𝖻𝗅𝖾 ]</code></b>"""
    ...
    RESTART_GC_TXT = """
<b>😎 நான் வீழ்வேன் என்று நினைத்தாயோ? 😏
