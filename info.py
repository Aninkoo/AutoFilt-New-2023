...
BOT_TOKEN = environ.get('BOT_TOKEN', '7604276535:AAGLAFLPwvdGaMj6RLE5W9AXw1nSzTeeuAw')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001749888345').split()]
