...
BOT_TOKEN = environ.get('BOT_TOKEN', '5221907668:AAHY7SJ7TER85n7ycLfOQbBd0F_PIkfsXSI')
...
UPDATES_CHNL = int(environ.get('UPDATES_CHNL', '-1001513581337'))
...
SHORTLINK_URL = (environ.get("SHORTLINK_URL", "instantearn.in modijiurl.com")).split()
SHORTLINK_API = (environ.get("SHORTLINK_API", "85738b1e5dc3dc11333d57b84db5200978d82ec7 c480bd44e389cfe706aa346f1d9af0bd5d014b47")).split()
